  ...
  experience: [
    {
      ...
      endDate: "Presente",
      description: "Desarrollo de proyectos como Ingeniero de Proyectos Junior. Trabajo con tecnologías modernas en un entorno híbrido.",
      achievements: [
    ...
    },
    {
      ...
      endDate: "Agosto 2025",
      description: "Desarrollo de aplicaciones y APIs. Trabajo con tecnologías backend y frontend en jornada parcial.",
      achievements: [
    ...
    },
    {
      ...
      endDate: "Junio 2024",
      description: "Prácticas profesionales enfocadas en desarrollo web backend.",
      achievements: [
  ...
  education: [
    {
      ...
      startDate: "2024",
      endDate: "2025",
      description: "Especialización en áreas como aprendizaje automático, analítica de datos y toma de decisiones basadas en datos. Tecnologías: Scikit-learn, Neo4j y otras herramientas de Big Data."
    },
    {
      institution: "IES Comercio",
      ...
      startDate: "2022",
      endDate: "2024",
      description: "Formación en desarrollo de aplicaciones multiplataforma. Tecnologías: Android Studio, .NET Core y otras herramientas de desarrollo."
    }
  ],
  skills: [
    {
      category: "Lenguajes de Programación",
      items: ["JavaScript", "TypeScript", "PHP", "Python", "Java","Node.js","MySQL","PostgreSQL","MongoDB"]
    },
    {
    ...
    },
    {
      ...
      items: ["Amazon Web Services (AWS)", "AWS S3", "AWS Lambda", "Neo4j", "Big Data"]
    },
    {
      category: "Herramientas y Tecnologías",
      items: ["Git", "API de Postman", "Android Studio", "Desarrollo de API", "Telefonía", "Asterisk"]
    },
    {
      category: "Áreas de Especialización",
      items: ["Backend Development", "Inteligencia Artificial", "Machine Learning", "Análisis de Datos", "Desarrollo Multiplataforma"]
    }
  ],
  projects: [
    {
    ...
    },
    {
      ...
      description: "Diferentes proyectos y recursos de programación de IA realizados en el curso de especialización en IA y Big Data.",
    ...
    {
      name: "SparkTesting",
      description: "Práctica de testing de Spark realizada en el curso de especialización en IA y Big Data.",
      technologies: ["Python", "Spark"],
      github: "https://github.com/guilleDCMdev/practica_spark_guillermoDeCarlosMunoz",
      demo: "",
      image: ""
    },
    {
...

    {
      ...
      description: "Generador de avatares personalizados, solo para practicar y divertirme",
  ...
  certifications: [
    {
      ...
      date: "Marzo 2025",
      credential: "https://www.credly.com/badges/83360eed-b985-4eee-9d93-caf10f773127/public_url"
    },
    {
      name: "React",
      issuer: "OpenWebinars",
